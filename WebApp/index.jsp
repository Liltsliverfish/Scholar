   ...
   <!-- Wrapper -->
		<div id="wrapper">
			...
			<header id="header">
				...
				<div class="content">
					<div class="inner">
						<h1>中小学教育机器人课程管理系统</h1>
						<p>中小学机器人教育的学习平台<br/> Learning platform for primary and secondary school robot education </p>
					</div>
				</div>
				<nav>
					<ul>
			...
			<div id="main">
				...
				<article id="login">
					...
					<form  name="login_form">
						...
						<div class="field">
							<input type="checkbox" name="rememberMe" id="rememberMe" value="false"/>记住我
						</div>
						<ul class="actions">
							<li><input value="登录" class="loginButton" type="button"/></li>
