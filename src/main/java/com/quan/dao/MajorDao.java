...
public interface MajorDao {
	...
	@Results({ @Result(id = true, property = "majorId", column = "majorId"),
			@Result(property = "department", column = "departmentId", one = @One(select = "com.quan.dao.DepartmentDao.getById")),
	...
	@Results({ @Result(id = true, property = "majorId", column = "majorId"),
		@Result(property = "department", column = "departmentId", many = @Many(select = "com.quan.dao.DepartmentDao.getById")),
		@Result(property = "majorName", column = "majorName") })
