...
public interface MessageDao {
	...
	@Results({ @Result(id = true, property = "messageId", column = "messageId"),
			@Result(property = "user", column = "userId", one = @One(select = "com.quan.dao.UserDao.getById")),
			@Result(property = "lesson", column = "lessonId", one = @One(select = "com.quan.dao.LessonDao.getById")),
			@Result(property = "parentMessage", column = "parentMessageId", one = @One(select = "com.quan.dao.MessageDao.getById")),
	...
	@Results({ @Result(id = true, property = "messageId", column = "messageId"),
			@Result(property = "user", column = "userId", one = @One(select = "com.quan.dao.UserDao.getById")),
			@Result(property = "lesson", column = "lessonId", one = @One(select = "com.quan.dao.LessonDao.getById")),
			@Result(property = "parentMessage", column = "parentMessageId", many = @Many(select = "com.quan.dao.MessageDao.getById")),
			@Result(property = "messageTime", column = "messageTime"),
			@Result(property = "messageContent", column = "messageContent") })
	...
	@Results({ @Result(id = true, property = "messageId", column = "messageId"),
			@Result(property = "user", column = "userId", one = @One(select = "com.quan.dao.UserDao.getById")),
			@Result(property = "lesson", column = "lessonId", one = @One(select = "com.quan.dao.LessonDao.getById")),
			@Result(property = "targetUser", column = "targetUserId", one = @One(select = "com.quan.dao.UserDao.getById")),
