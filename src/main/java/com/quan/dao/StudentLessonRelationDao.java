...
public interface StudentLessonRelationDao {
	...
	@Results({ @Result(column = "studentLessonRelationId", id = true, property = "studentLessonRelationId"),
			...
			@Result(column = "lessonId", property = "lesson", one = @One(select = "com.quan.dao.LessonDao.getById")), })
	...
	@Results({ @Result(column = "studentLessonRelationId", id = true, property = "studentLessonRelationId"),
			...
			@Result(column = "lessonId", property = "lesson", many = @Many(select = "com.quan.dao.LessonDao.getById")), })
	...
	@Results({ @Result(column = "lessonId", id = true, property = "lessonId"),
		@Result(column = "teacherId", property = "teacher", one = @One(select = "com.quan.dao.UserDao.getById")),
		@Result(column = "majorId", property = "major", one = @One(select = "com.quan.dao.MajorDao.getById")),
