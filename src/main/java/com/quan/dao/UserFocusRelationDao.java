...
public interface UserFocusRelationDao {
	...
	@Results({ @Result(id = true, property = "userFocusRelationId", column = "userFocusRelationId"),
			@Result(property = "user", column = "userId", many = @Many(select = "com.quan.dao.UserDao.getById")),
			@Result(property = "targetUser", column = "targetUserId", one = @One(select = "com.quan.dao.UserDao.getById")) })
	...
	@Results({ @Result(id = true, property = "userFocusRelationId", column = "userFocusRelationId"),
			@Result(property = "user", column = "userId", one = @One(select = "com.quan.dao.UserDao.getById")),
			@Result(property = "targetUser", column = "targetUserId", many = @Many(select = "com.quan.dao.UserDao.getById")) })
